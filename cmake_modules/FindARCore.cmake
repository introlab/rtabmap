...
FIND_LIBRARY(ARCore_LIBRARY NAMES arcore_sdk_c PATH_SUFFIXES ${ANDROID_ABI})

IF (ARCore_INCLUDE_DIR AND ARCore_LIBRARY)
   SET(ARCore_FOUND TRUE)
   SET(ARCore_INCLUDE_DIRS ${ARCore_INCLUDE_DIR})
   SET(ARCore_LIBRARIES ${ARCore_LIBRARY})
ENDIF (ARCore_INCLUDE_DIR AND ARCore_LIBRARY)
